<template>
    <div id="CreatePost" class="fixed z-50 bottom-0 h-full w-full overflow-hidden">
        <div class="bg-black h-full w-full text-white overflow-auto">
            ...
            <button v-if="text" :disabled="isLoading" class="fixed bottom-0 font-bold text-lg bg-black text-white w-full inline-block p-4 border-t-gray-700" :class="isLoading ? 'text-gray-600' : 'text-blue-600'">
